...
Please note that no tests are added here except a command for connecting to metamask for the specific application. Use this as reference for you project.
